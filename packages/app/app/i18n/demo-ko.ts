...
export const demoKo: DemoTranslations = {
            ...
            passingContent: {
                ...
                useCase: {
                    ...
                    switch: {
                        ...
                        helper: '기본적으로 이 옵션은 `Text`를 사용하지 않습니다. 폰트에 따라 켜기/끄기 문자가 이상하게 보일 수 있기 때문입니다. 필요에 따라 커스터마이즈하세요.',
                    },
                    switchAid: {
                        label: '또는 아이콘으로 보조',
                    },
    ...
    demoText: {
        description: '텍스트 표시가 필요한 경우를 위해, 이 컴포넌트는 기본 React Native 컴포넌트 위에 HOC로 제작되었습니다.',
        useCase: {
            presets: {
                name: '프리셋',
                description: '사전 구성된 몇 가지 프리셋이 있습니다.',
    ...
    demoEmptyState: {
        description: '표시할 데이터가 없을 때 사용할 수 있는 컴포넌트입니다. 사용자가 다음에 무엇을 할지 안내할 수 있습니다.',
        useCase: {
            presets: {
                name: '프리셋',
                description:
