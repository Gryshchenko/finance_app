export const demoEs = {
            ...
            passingContent: {
                ...
                useCase: {
                    ...
                    switch: {
                        ...
                        helper: 'Por defecto, esta opción no usa `Text` ya que, dependiendo de la fuente, los caracteres on/off podrían no dibujarse bien. Personalízalo según tus necesidades.',
                    },
                    switchAid: {
    ...
    demoListItem: {
        ...
        useCase: {
            height: {
                ...
                textHeight: 'Altura determinada por el contenido del texto - Reprehenderit incididunt deserunt do do ea labore.',
    ...
    demoHeader: {
        description: 'Componente desplegado en varias pantallas. Va a contener botones de navegación y el título de la pantalla.',
        useCase: {
            actionIcons: {
