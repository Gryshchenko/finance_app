...
const ja = {
    ...
    demoCommunityScreen: {
        title: 'コミュニティと繋がろう',
        tagLine: 'Infinite RedのReact Nativeエンジニアコミュニティに接続して、一緒にあなたのアプリ開発をレベルアップしましょう！',
        ...
        hireUs: 'それがプロジェクト全体でも、チームにトレーニングをしてあげたい時でも、Infinite RedはReact Nativeのことであればなんでもお手伝いができます。',
        hireUsLink: 'メッセージを送る',
    },
    demoShowroomScreen: {
