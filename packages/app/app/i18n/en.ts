const en = {
    ...
    settingsChangePasswordScreen: {
        ...
        description:
            'Enter your current password. We will send a code to your email, and you will choose the new password after confirming it.',
    ...
    settingsChangePasswordNewScreen: {
        name: 'New Password',
        description: 'Choose your new password. Your password changes only once you save it here.',
        newPassword: 'New Password',
        repeatPassword: 'Repeat Password',
        saveButton: 'Save',
        codeLost: 'Your confirmation code was lost. Please start again.',
        successMessage: 'Password changed successfully. Please sign in again.',
    },
