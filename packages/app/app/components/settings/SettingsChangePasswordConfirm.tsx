...
export const SettingsChangePasswordConfirmation: FC = function SettingsChangePasswordConfirmation() {
    ...
    return (
        <View style={$container}>
            <View style={$body}>
                <Text tx="settingsChangePasswordConfirmScreen:description" style={themed($description)} />
            ...
            {resendTimer > 0 && (
                <View style={$timerRow}>
                    <Text tx="settingsChangePasswordConfirmScreen:timerHelper" style={themed($timerHelper)} />
            ...
            />
            <TextButton
                tx={'settingsChangePasswordConfirmScreen:resendButton'}
                style={themed($tapButton)}
                onPress={refresh}
                preset={'reversed'}
